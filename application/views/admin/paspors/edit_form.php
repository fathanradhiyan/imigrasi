...
<body class= "sb-nav-fixed" id="page-top">
	...
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			...
			<h2 class="mt-4">Edit Data Pemohon Paspor</h1>
				...
				<div class="card mb-4">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
						<!-- Note: atribut action dikosongkan, artinya action-nya akan diproses 
							...
							<input type="hidden" name="id" value="<?php echo $paspors->id_pemohonpaspor?>" />
							
                            <div class="form-group">
								<label for="np_paspor">NP</label>
								<input class="form-control <?php echo form_error('np_paspor') ? 'is-invalid':'' ?>"
								 type="text" name="np_paspor" placeholder="NP" value="<?php echo $paspors->np_paspor ?>" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('tglpermohonan') ? 'is-invalid':'' ?>"
                                 ...
                                 value="<?php echo $paspors->tglpermohonan ?>" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('tglcetak') ? 'is-invalid':'' ?>"
                                 ...
                                 value="<?php echo $paspors->tglcetak ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('noregistrasi') ? 'is-invalid':'' ?>"
								 type="text" name="noregistrasi"  placeholder="Nomor Registrasi" value="<?php echo $paspors->noregistrasi ?>"/>
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>"
								 type="text" name="nama"  placeholder="Nama" value="<?php echo $paspors->nama ?>"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('jkelamin') ? 'is-invalid':'' ?>"
								 type="text" name="jkelamin" placeholder= "Jenis Kelamin" value="<?php echo $paspors->jkelamin ?>"/>
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('jpermohonan') ? 'is-invalid':'' ?>"
								 type="text" name="jpermohonan"  placeholder="Jenis Permohonan" value="<?php echo $paspors->jpermohonan ?>"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('no_paspor') ? 'is-invalid':'' ?>"
								 type="text" name="no_paspor" placeholder="Nomor Paspor" value="<?php echo $paspors->no_paspor ?>"/>
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								<label for="mksdkeberangkatan">Makskud Keberangkatan</label>
								<input class="form-control <?php echo form_error('mksdkeberangkatan') ? 'is-invalid':'' ?>"
								 name="mksdkeberangkatan" placeholder="Maksud Keberangkatan" value="<?php echo $paspors->mksdkeberangkatan ?>"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('lokasi') ? 'is-invalid':'' ?>"
								 type="text" name="lokasi"  placeholder="Lokasi Penyimpan Arsip Fisik" value="<?php echo $paspors->lokasi ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control-file <?php echo form_error('file') ? 'is-invalid':'' ?>"
								 type="file" name="file" />
                                 <input type="hidden" name="old_file" value="<?php echo $paspors->file ?>"/>
								<div class="invalid-feedback">
