                                ...
                                <div class="nav <?php echo $this->uri->segment(2) == 'dpri' ? 'active': '' ?>">
                                    ...
                                    <div class="sb-nav-link-icon"><i class="fas fa-file"></i></div>
                                        ...
                                        <div class="collapse" id="collapseDPRI" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                            ...
                                            <a class="nav-link" href="<?php echo site_url('admin/statistik') ?>">Statistik Paspor</a>
                                            </nav>
                                     </div>
                                </div>
                                ...
                                <div class="nav <?php echo $this->uri->segment(2) == 'user' ? 'active': '' ?>">
                                    ...
                                    Manajemen Users
                                        ...
                                        <div class="collapse" id="collapseUser" aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
                                            ...
                                            <a class="nav-link" href="<?php echo site_url('admin/Profile') ?>">My Profile</a>
                                            </nav>
                                     </div>
                                </div>

                                <div class="sb-sidenav-menu-heading">Logout</div>
                                <div class="nav <?php echo $this->uri->segment(2) == 'logout' ? 'active': '' ?>">
                                     <a class="nav-link collapsed" href="<?php echo site_url('Login/logout') ?>" onclick= "return confirm('Are you sure?')"
                                     data-bs-toggle="collapse" data-bs-target="#collapseLogout" aria-expanded="false" aria-controls="collapseLogout">
